...
//       const res = await axios.post("https://socialnetworkingsite.onrender.com/post/upload", input,
//         {
//           // headers: {
...
//               </>
//             ) : (
//               <div className="flex flex-col items-center justify-center h-2/3 border-2 border-dashed border-gray-500 rounded-lg p-6 m-4">
